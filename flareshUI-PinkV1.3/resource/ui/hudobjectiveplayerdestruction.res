...
{	
	...
	"ScoreContainer"
	{
		...
		"ProgressBarContainer"
		{
			...
			"EscrowBlueShadow" //Blue bottles shadow
			{
				"ControlName"	"CExLabel"
			...
			"EscrowRedShadow" //Red Bottles shadow
			{
				"ControlName"	"CExLabel"
	...
	"CountdownContainer"
	{
		...
		"CountdownLabelTime"  //ufo countdown
		{
			"ControlName"	"CExLabel"
